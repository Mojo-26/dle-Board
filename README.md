...
👉 [View the board here](https://mojo-26.github.io/dle-Board/)

---

## What it is

A single HTML file you can open in any browser and/or share directly with friends and coworkers. No installation, no account, no server required. Just open and play.

---

## Features

- **150+ games** across 18 categories including Words, Geography, Music, Movies/TV, Math/Logic, Video Games, Sports, Science, History, and more
...
Game list adapted from [The Dles](https://github.com/aukspot/dles) by aukspot, used under the GPL-3.0 license. Not affiliated with any of the games listed (besides Casefile - which is mine). Each game links to its own independent website.

Built with plain HTML, CSS, and JavaScript — no frameworks, no dependencies, no build step. Thanks be to Claude.
